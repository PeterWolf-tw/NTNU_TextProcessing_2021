...
if __name__ == "__main__":
    ...
    birth =txt.split("\n")[2]
    i=1
    for key,value in jsonDICT["birth"].items():
        jsonDICT["birth"][key]= birth.split(" ")[2*i - 1]
        i+=1
    ...
    #print(jsonDICT)
    jsonFileName = "week03_40947016S.json"
    jsonFileWriter(jsonDICT, jsonFileName)
    with open("week03_40947016S.json", encoding="utf-8") as f:
        print(f.read())
